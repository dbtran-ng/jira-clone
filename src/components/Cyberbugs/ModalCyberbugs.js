                  ...
                  <div className="comment">
                    ...
                    <div className="block-comment" style={{ display: 'flex' }}>
                      <div className="avatar">
                        <img
                          src={require('../../assets/download (1).jfif')}
                          alt="xyz"
                        />
                      </div>
                  ...
                  <div className="assignees">
                    ...
                    <div className="row">
                      ...
                      <div className="col-6  mt-2 mb-2">
                        <Select
                          options={projectDetails.members
                            ?.filter((mem) => {
                          ...
                          onSelect={(value) => {
                            ...
                            let userSelected = projectDetails.members.find(
